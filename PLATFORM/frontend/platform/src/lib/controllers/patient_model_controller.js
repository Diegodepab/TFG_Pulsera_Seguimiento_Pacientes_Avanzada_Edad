...
import { PatientModelFetch } from "$lib/services/fetch/patient_model_fetch";

class PatientModelController extends BaseController {
  /** @type {PatientModelFetch} */
  fetch;

  constructor() {
    super();
    this.fetch = new PatientModelFetch();
  }
